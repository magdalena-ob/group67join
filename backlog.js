...
function createBacklogCards() {
    for (let i = 0; i < allTasks.length; i++) {
        ...
        <div id="backlogCard" class="backlogCard" style="border-left-color: ${allTasks[i]["color"]};">
            <div class="firstDates">    
                <div id="showTitle"><b>Title</b>
                    <div id="currenTitle" class="black">${allTasks[i]["title"]}
                    </div>
                </div>
                <div id="creationDate"><b>CreationDate</b>
                    <div id="currentCreationDate" class="black">${creationDate}
                    </div>
                </div>
                <div id="deadLine"><b>DeadLine</b>
                    <div id="currentDeadLine" class="black">${allTasks[i]["deadline"]}
                    </div>
                </div>
            </div>
            <div class="secondDates">
                <div id="status"><b>Status</b>
                    <div id="currentStatus" class="black">${allTasks[i]["status"]}
                    </div>
                </div>
                <div id="urgency"><b>Urgency</b>
                    <div id="currentUrgency" class="black">${allTasks[i]["urgency"]}
                    </div>
                </div>
                <div id="description">            
                    <p>
